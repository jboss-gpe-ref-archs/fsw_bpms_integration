...
A message sent to this queue with a String property that matches this selector will get routed to the _processMgmt_ bean component of the _processMgmtTier_ SwitchYard application.
. *processMgmtTier SwitchYard application* : primary focal point of this reference architecture.
...
Notice the significant involvement of the _ProcessMgmtTier_ SwitchYard application to invoke the remote Process and Human Task engines.
