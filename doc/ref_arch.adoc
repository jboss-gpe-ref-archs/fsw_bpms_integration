...
The intent of deploying the domain model library as a static shared JBoss module is to add the domain model libraries to the class-path of BPM Suite 6 Business-Central web application.
In general, there are other approaches to adding libraries to the class-path of web applications that the user of this reference architecture could additionally explore.

Execute the following steps for both your remote BPM Suite 6 and FSW OpenShift gears:
