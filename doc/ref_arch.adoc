...
For the purposes of this reference architecture, the Fuse Service Works product will execute in an OpenShift Enterprise 2 _application_.
The FSW application will include the following :
